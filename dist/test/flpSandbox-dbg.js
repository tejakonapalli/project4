		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#project4sacrd2project4-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"project4sacrd2project4-display": {
								"semanticObject": "project4sacrd2project4",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=project4sacrd2.project4",
									"url": sap.ui.require.toUrl("project4sacrd2/project4")
								}
							}
						}
					}
